    ...
    <div className="sign-up-container">
      ...
      <form onSubmit={handleSignUpSubmit}>
        ...
        <label>
          Birthdate
          <br></br>
          <input className="sign-up-birthdate sign-up-input" type="date" onChange={handleBirthdateChange} placeholder="MM/DD/YYYY" required></input>
        </label>
        <br></br>
        <input type="submit" value="SIGN UP" className="sign-up-button"></input>
      </form>
      <Link to="/login" className="sign-up-login-link" >Already have an account? Log in here!</Link>
    </div>
  )
}
